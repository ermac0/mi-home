...
namespace MiLight.Lights
{
	...
	public class RGBLights : BaseLights // 'Legacy' lights without group support
	{
		...
		/// </summary>
		/// <param name="miLightGateway">The parent <see cref="MiLightGateway"/> of this light.</param>
		public RGBLights(MiLightGateway miLightGateway) : base(miLightGateway) {}
